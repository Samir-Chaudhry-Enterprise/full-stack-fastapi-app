...
def create_sample_data(session: Session) -> None:
    ...
    sample_items = [
        ...
        {"title": "Client Call", "description": "Quick reminder about the client call", "item_type": "Work"},
        ...
        {"title": "Project Planning", "description": "Q4 planning", "item_type": "Work"},
        {"title": "Home Repairs", "description": "Fix the sink", "item_type": "Chore"},
    ]
